...
//	@Override
//	public List<YycgdmxCustom> findYybusinessListSum(String yycgdid, YycgdQueryVo yycgdQueryVo) throws Exception {
//		yycgdQueryVo = yycgdQueryVo != null ? yycgdQueryVo : new YycgdQueryVo();
//		// 设置采购单id
...
//		return yybusinessMapperCustom.findYybusinessListSum(yycgdQueryVo);
//	}
